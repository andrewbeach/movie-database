(defproject fulcrologic/movie-database "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "movie_database.jar"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          movie-database.client-main
                                       :optimizations :advanced
                                       :externs       ["externs.js"]
                                       :source-map    "resources/public/js/movie_database.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/movie_database.js"}}]}

  :profiles {:uberjar    {:main           movie-database.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "movie-database.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          movie-database.client-test-main
                                                          :optimizations :none
